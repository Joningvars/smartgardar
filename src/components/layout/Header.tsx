...
export function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 mx-4 mt-2 md:mx-6">
      <div className="mx-auto rounded-lg bg-white/80 backdrop-blur-3xl shadow-md px-5 py-5 md:px-8 md:py-4">
        {/* Desktop layout */}
        <div className="hidden md:flex items-center justify-between relative">
          ...
          <div className="flex items-center">
            <Link
              to={ctaItem.path}
              className="cursor-pointer rounded-full bg-[#dbfeb8] px-5 py-2 text-base font-medium text-(--color-text) transition-colors hover:bg-[#cdf4a8]"
            >
              {ctaItem.label}
            </Link>
          </div>
